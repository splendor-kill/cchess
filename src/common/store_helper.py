def get_store_util(resource_config):
    ...
    if which_storage == 's3':
        ...
        return S3Helper(resource_config.distributed_s3_url,
                        resource_config.distributed_s3_access_key,
                        resource_config.distributed_s3_secret_key,
                        resource_config.distributed_s3_bucket
                        )
